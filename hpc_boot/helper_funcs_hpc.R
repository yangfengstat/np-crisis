# helper_funcs_hpc.R -- HPC-lean copy of np-crisis-helper-funcs-r2.R.
# Identical function definitions; only the library block is reduced to the
# packages actually needed for the i.model >= 2 (npc) calibration path.
suppressMessages({
  library(nproc)
  library(ada)
